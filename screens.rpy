...
screen fame_display():
    text "Слава: [fame_level]" xpos 0.01 ypos 0.01 size 30 color "#FFFFFF"
    text "Здоровье: [health]" xpos 0.01 ypos 0.04 size 30 color "#ff0000"
    text "Ноктусы: [noctus]" xpos 0.01 ypos 0.07 size 30 color "#ffd900"
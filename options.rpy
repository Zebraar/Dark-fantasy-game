...
define config.name = _("Dark fantasy game")
...
define config.version = "0.08.4"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("""Эта игра про приключение в мире Dark fantasy! Уверяю вас приключение будет захватывающим! Эта игра только на 8 альфе! Вней 1576 строк кода.
""")
...
define config.save_directory = "Darkfantasy-1737523524"
